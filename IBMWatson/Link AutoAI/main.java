    ...
    public static void main(String[] args) throws IOException {
        ...
        try {
            ...
            URL scoringUrl = new URL(
                    "https://us-south.ml.cloud.ibm.com/v4/deployments/76260a02-f113-4f48-be7e-42a2fee91d82/predictions");
            ...
            // next line
            String payload = "{\"input_data\": [{\"fields\": [\"url\"], \"values\": [array_of_values_to_be_scored, another_array_of_values_to_be_scored]}]}";
